package net.fishlulu.tutorialmod.networking;
...
public class ModMessages  {
    ...
    {
        SimpleChannel net = NetworkRegistry.ChannelBuilder.named(new ResourceLocation(TutorialMod.MOD_ID,"messages"))
    ...
    {
        INSTANCE.sendToServer(message);//anything can be a message basically so use generic type MSG
    }
    //send to player
